 ...
 */
public class LoginPage extends FragmentActivity implements
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        //Jared attempts to switch to the front page intent now.
        MyProperties.getInstance().email = Plus.AccountApi.getAccountName(mGoogleApiClient);
        Log.e("?", MyProperties.getInstance().email);
        Intent intent = new Intent(this, FrontPage.class);
        startActivity(intent);

        //hopefully these two lines will stop it from not letting you go back to the login screen
        //if not try moving them above the Intent declaration
        mGoogleApiClient.disconnect();
        onSignedOut();
    }
    ...
    public boolean onUploadServerAuthCode(String idToken, String serverAuthCode) {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(LoginPage.this, responseBody, Toast.LENGTH_LONG).show();
                }
            });
